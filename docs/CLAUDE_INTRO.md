...
* Origin = back-left-bottom of cabinet footprint
* X+ = right
* Y+ = toward wall (cabinet body projects in -Y)
* Z+ = up
* pos.y = front face of cabinet (geometry builds from y toward +Y)
* front_y = shared front-face plane for all base/tall cabinets
* wall_mount_z = base_body_h + toe_kick_h (elevation for wall cabinets)
